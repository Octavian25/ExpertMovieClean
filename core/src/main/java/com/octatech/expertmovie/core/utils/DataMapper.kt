    ...
    fun mapResponsesToEntitiesSeries(input: List<SeriesResponse>): List<SeriesEntity> {
        ...
        input.map {
            val series = SeriesEntity(
                id = it.id,
                backdropPath = it.backdropPath ?: "http://mti.fti.upnyk.ac.id/asset/images/no-image.png",
                ...
                overview = it.overview,
                popularity = it.popularity,
                posterPath = it.posterPath ?: "http://mti.fti.upnyk.ac.id/asset/images/no-image.png",
                voteAverage = it.voteAverage,
                voteCount = it.voteCount,
                isFavorite = false
            )
